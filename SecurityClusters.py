...
output_dir = 'security-figs'
os.makedirs(output_dir, exist_ok=True)

# Build dataframe from CSV file holding 500 code check-in files from OpenDev.
df = pd.read_csv('C:\ssw-565-final\ssw-565-final\Security_Check_Ins.csv', encoding='utf-8', encoding_errors='ignore')
